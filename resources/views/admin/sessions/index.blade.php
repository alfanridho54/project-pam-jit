                        ...
                        @forelse ($jitSessions as $jitSession)
                            <tr class="hover:bg-slate-50/40 transition">
                                <td class="px-6 py-4 text-sm text-slate-900">
                                    <div class="font-semibold text-slate-900">{{ $jitSession->user->name }}</div>
                                    <div class="text-xs text-slate-400">{{ $jitSession->user->email }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right text-sm">
                                    <a href="{{ route('admin.sessions.show', $jitSession) }}" class="font-semibold text-indigo-600 hover:text-indigo-900 transition">
                                        {{ __('View Details') }}
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-sm text-slate-400">
                                    <div class="flex flex-col items-center justify-center space-y-2">
                                        ...
                                        <span>{{ __('No JIT sessions have been started yet.') }}</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
